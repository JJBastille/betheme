				...
				<ul class="contact_details">
					<?php
						...
						if( $header_phone = mfn_opts_get( 'header-phone' ) ){
							echo '<li class="phone"><i class="icon-phone"></i><a class="animate-all none-underline" href="tel:'. str_replace(' ', '', $header_phone) .'">'. $header_phone .'</a></li>';
						}					
						if( $header_phone_2 = mfn_opts_get( 'header-phone-2' ) ){
							echo '<li class="phone"><i class="icon-phone"></i><a class="animate-all none-underline" href="tel:'. str_replace(' ', '', $header_phone_2) .'">'. $header_phone_2 .'</a></li>';
						}					
						if( $header_email = mfn_opts_get( 'header-email' ) ){
							echo '<li class="mail"><i class="icon-mail-line"></i><a class="animate-all none-underline" href="mailto:'. $header_email .'">'. $header_email .'</a></li>';
						}
					?>

					<li class="topbar_linkedin"><a href="https://fr.linkedin.com/company/easii-ic" target="_blank"><img src="http://localhost/wordpress/wp-content/uploads/2017/08/linkedin.png" alt="LinkedIn"/></a></li>

					<li class="topbar_contact"><a href="#" target="_blank">Contact</a></li>
